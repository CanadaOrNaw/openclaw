...
export const de: TranslationMap = {
  ...
  mcpServers: {
    ...
    sessionUnavailable:
      "Die aktive Sitzung ist nicht verfügbar; aktualisieren Sie die Ansicht und versuchen Sie es erneut.",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Aktiviert Schutzmechanismen auf Basis des bisherigen Verlaufs, die vor wiederholten Tool-Aufrufen warnen oder sie blockieren, wenn ein Agent keine Fortschritte mehr macht.",
    },
    localModelLean: {
  ...
  dreaming: {
    ...
    wiki: {
      ...
      emptyWiki: "Das Memory-Wiki enthält noch keine Inhalte",
      emptyWikiHint:

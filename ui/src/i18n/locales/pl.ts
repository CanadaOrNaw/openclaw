...
export const pl: TranslationMap = {
  ...
  modelSetup: {
    ...
    manual: {
      ...
      selectProviderHint: "Wybierz, skąd pochodzą te dane uwierzytelniające",
      ...
      verifyHint:
        "OpenClaw weryfikuje rzeczywistą odpowiedź modelu przed oznaczeniem połączenia jako gotowe.",
      required: "Wybierz dostawcę i wprowadź klucz API lub token.",
    },
    success: {
      title: "Twoja sztuczna inteligencja jest gotowa",
      body: "OpenClaw otrzymał rzeczywistą odpowiedź od {modelRef}. Możesz teraz rozpocząć rozmowę.",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelSetupTitle: "Docieraj do OpenClaw poza tą aplikacją",
      channelSetupBody:
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Włącz zabezpieczenia oparte na historii, które ostrzegają lub blokują powtarzające się wywołania narzędzi, gdy agent przestaje robić postępy.",
    },
    localModelLean: {
    ...
    composer: {
      ...
      menu: {
        ...
        toolAccess: {
          ...
          noTools: "Brak dostępnych narzędzi dla tego konektora.",

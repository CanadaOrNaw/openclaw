...
export const uk: TranslationMap = {
  ...
  mcpServers: {
    ...
    sessionEnableFailed:
      "Сервер було збережено як глобально вимкнений, але ввімкнути його для цього сеансу не вдалося: {error}",
    sessionChanged: "Активний сеанс змінився до того, як сервер вдалося ввімкнути.",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Увімкніть захисні механізми на основі ковзної історії, які попереджають або блокують повторні виклики інструментів, коли агент перестає просуватися вперед.",
    },
    localModelLean: {
  ...
  dreaming: {
    ...
    wiki: {
      ...
      emptyWiki: "Вікі пам’яті ще не наповнено",
      emptyWikiHint:
  ...
  chat: {
    ...
    composer: {
      ...
      menu: {
        ...
        scopeSessionHint:
          "Сервер зберігається як глобально вимкнений і вмикається лише для цього сеансу.",
        scopeEverywhereHint: "Сервер зберігається та вмикається для кожного сеансу.",
        toolAccess: {

...
export const nl: TranslationMap = {
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      ollamaButton: "Controleren & instellen",
      ollamaLabel: "Ollama",
    ...
    manual: {
      ...
      connect: "Verbinden",
      connectAndVerify: "Verbinden & verifiëren",
      verifyHint:
        "OpenClaw verifieert een echte modelreactie voordat de verbinding als gereed wordt gemarkeerd.",
      required: "Kies een provider en voer een API-sleutel of token in.",
    },
    success: {
      title: "Je AI is klaar",
      body: "OpenClaw heeft een echte reactie ontvangen van {modelRef}. U kunt nu beginnen met chatten.",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelSetupBody:
        "De webapp werkt al. Voeg alleen een kanaal toe als u OpenClaw vanuit een andere dienst wilt berichten.",
  ...
  mcpServers: {
    ...
    sessionEnableFailed:
      "De server is wereldwijd uitgeschakeld opgeslagen, maar inschakelen voor deze sessie is mislukt: {error}",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Schakel bescherming op basis van doorlopende geschiedenis in die waarschuwt of herhaalde toolaanroepen blokkeert wanneer een agent geen voortgang meer boekt.",
    },
    localModelLean: {

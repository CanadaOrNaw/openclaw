...
export const tr: TranslationMap = {
  ...
  modelSetup: {
    ...
    success: {
      ...
      body: "OpenClaw, {modelRef} modelinden gerçek bir yanıt aldı. Artık sohbete başlayabilirsiniz.",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Bir aracı ilerleme kaydetmeyi durdurduğunda tekrarlanan araç çağrılarını uyaran veya engelleyen sürekli geçmiş korumalarını etkinleştirin.",
    },
    localModelLean: {

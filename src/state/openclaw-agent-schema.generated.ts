...
CREATE INDEX IF NOT EXISTS idx_agent_session_nodes_trimmed_session_key
  ON session_nodes(trim(session_key, char(9,10,11,12,13,32,160,5760,8192,8193,8194,8195,8196,8197,8198,8199,8200,8201,8202,8232,8233,8239,8287,12288,65279)))
  WHERE session_key <> trim(session_key, char(9,10,11,12,13,32,160,5760,8192,8193,8194,8195,8196,8197,8198,8199,8200,8201,8202,8232,8233,8239,8287,12288,65279));
